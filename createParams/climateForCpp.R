...
#### Aim of prog: Create the environment data for C++ program
## Temperature:
...
# crs = stri_replace_all(str = crs, replacement = "", regex = "")
...
## Set a (x, y) coordinate in NYC (A tree grows in Brooklyn...)
x = 2150631.67
y = -131511.69
